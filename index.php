      ...
      <div class="container">
        ...
        <div class="navbar-header">
          <button type="button" class="navbar-toggle" data-toggle="collapse" data-target="#navbar">
            ...
            <a class="navbar-brand" href="#"> G-CLUSTER </a>
        </div>
        <!-- barre de menu -->
    ...
    <main>
      <div class="main-content">
          <div class="main-content-inner">
              ...
              <p>Le cluestering consiste à regrouper un ensemble d'équipe dans des groupes homogènes équilibrés géographiquement. Commancez par importer votre fichier ".csv" contenant sur chaque ligne le nom puis l'adresse d'une équipe séparés par un point virgule.</p>
